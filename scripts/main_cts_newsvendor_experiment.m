...
for m = 1:M
    ...
    [S_indicators_dinf(:,m), D_x0s, S_poly_indicators_dinf(:,m), ~] = PO_screen(feas_region, exp_set, sample_mean, sample_var, n_vec, alpha, 'ellinf', fn_props, prop_params, LP_solver_string);
