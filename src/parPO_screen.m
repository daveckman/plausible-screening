function [S_indicators, D_x0s, S_poly_indicators, zs, PO_times, PO_relaxed_times] = parPO_screen(cluster, feas_region, exp_set, sample_mean, sample_var, n_vec, discrep_string, D_cutoff, fn_props, prop_params, LP_solver_string)
