function [S_indicators, D_x0s, S_poly_indicators] = GPSinf_screen(feas_region, exp_set, sample_mean, sample_mean_grad, sample_full_cov, n_vec, D_cutoff_gradinf)
...
for l = 1:card_feas_region
    ...
    D_x0s(l) = calc_min_std_discrep_gradinf(A, C, b, sample_mean, sample_mean_grad, sample_full_cov, n_vec);
    
    % Screen solution
    S_indicators(l) = (D_x0s(l) <= D_cutoff_gradinf);
end
