function [Sonlygrad_d2_indicators, Sonlygrad_dinf_indicators] = RGPS_onlygrad_screen(feas_region, exp_set, sample_mean, sample_mean_grad, sample_full_cov, n_vec, D_cutoff_dgrad, D_cutoff_dgradinf)
