function [S_indicators, D_x0s, S_poly_indicators, zs] = PS_screen_fast(feas_region, exp_set, sample_mean, sample_var, n_vec, discrep_string, D_cutoff, fn_props, prop_params, LP_solver_string, opttol)
...
for l = 1:card_feas_region
    ...
    [A, C, b] = PO_info_handle(x0, exp_set, prop_params, opttol);
