function [sample_mean, sample_var, sample_mean_grad, sample_full_cov] = generate_grad_data(m, oracle_string, oracle_n_rngs, exp_set, n_vec, discrep_string)
...
if strcmp(discrep_string, 'CRN') == 1
    ...
    sample_mean_grad = zeros(k,d);
    sample_full_cov = zeros(d+1,d+1,k);
    ...
    for i = 1:k
        ...
        % Take n_i replications at x_i
        [outputs, gradients] = oracle_handle(oracle_rngs, x_i, n_i);
